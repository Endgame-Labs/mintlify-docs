...
<Info>
  **Learning path:** [Implementation Guide](/academy/implementation-guide) · Module 1 of 8 · ~10 minutes
</Info>
...
<Columns cols={2}>
  <Column>
    <Card icon="arrow-big-left" horizontal href="academy/initial-setup-guide" title="Previous Module">
      Initial Setup Guide
    </Card>
  </Column>
  <Column>
