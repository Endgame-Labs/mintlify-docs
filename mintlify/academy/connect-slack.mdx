...
<Info>
  **Learning path:** [Implementation Guide](/academy/implementation-guide) · Module 3 of 8 · ~10 minutes
</Info>
...
<Columns cols={2}>
  <Column>
    <Card icon="arrow-big-left" horizontal href="academy/connect-conversations" title="Previous Module">
      Connect Conversations
    </Card>
  </Column>
  <Column>
    <Card icon="arrow-big-right" horizontal href="academy/upload-knowledge" title="Next Module">
      Upload Knowledge
    </Card>
  </Column>
</Columns>