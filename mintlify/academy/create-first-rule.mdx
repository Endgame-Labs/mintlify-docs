...
- **Rules** are short behavioral directives. They tell Endgame _what to do_ in a specific situation. Keep each rule focused on a single instruction.
- **Knowledge** is reference material (battlecards, methodology guides, playbooks). It gives Endgame _information to draw from_.
- **Skills** define _what to ask_. They're structured prompts that ensure consistent outputs for repeatable workflows.
