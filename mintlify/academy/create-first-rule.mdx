...
<Info>
  **Learning path:** [Implementation Guide](/academy/implementation-guide) · Module 5 of 8 · ~15 minutes
</Info>
...
<Columns cols={2}>
  <Column>
    <Card icon="arrow-big-left" horizontal href="academy/upload-knowledge" title="Previous Module">
      Upload Knowledge
    </Card>
  </Column>
  <Column>
    <Card icon="arrow-big-right" horizontal href="academy/build-first-skill" title="Next Module">
