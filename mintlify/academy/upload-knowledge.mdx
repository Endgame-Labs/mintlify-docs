...
<Info>
  **Learning path:** [Implementation Guide](/academy/implementation-guide) · Module 4 of 8 · ~10 minutes
</Info>
...
<Columns cols={2}>
  <Column>
    <Card icon="arrow-big-left" horizontal href="academy/connect-slack" title="Previous Module">
      Connect Slack
    </Card>
  </Column>
  <Column>
    <Card icon="arrow-big-right" horizontal href="academy/create-first-rule" title="Next Module">
