...
After you’ve [connected](/integrations/initial-connection-to-endgame) Salesforce and Gong/Zoom, your Endgame rep will have you login. That’s when you can:
...
- Instruct your team to configure [tasks](/features/tasks)
