...
<Warning>
  **Beta:** Credential creation is only enabled for organizations in the REST API beta. Contact [support@endgame.io](mailto:support@endgame.io) to have the feature enabled for your organization.
</Warning>
