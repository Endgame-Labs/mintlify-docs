...
Click Invite User at the top right of the user table and populate the email for user that should receive an invitation. Set the user [role](/user-management#user-roles) for the user you are inviting. You will be able to monitor which users have accepted invitations in this view.
