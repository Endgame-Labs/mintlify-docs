...
### Configuring your role for more relevant responses

Users will now be prompted to enter details about their job role when first logging into Endgame, or upon their next login if they are existing users. Providing context about your role, including your responsibilities, level within your organization's hierarchy, types of activities you engage in, and the data most relevant to your work, will enable Endgame to deliver more accurate and meaningful responses to your prompts.
...
// Todo add images of initial screen and pref inputs
