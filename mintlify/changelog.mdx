...
## Introducting Mode Selection for Chat (Beta release)
Choose ⚡ Fast Mode for rapid responses to straightforward queries, or 🧠 Smart Mode for comprehensive, thoroughly researched answers to complex questions. This performance enhancement gives you greater control over your research workflow, we look forward to your feedback on this new capability!

<Frame>
  <img
    src="./images/fast-mode-home-10-16-25.png"
...
<Frame>
  <img
    src="./images/multi-mode-10-16-25.png"
    alt="Template Management"
    className="rounded-lg"
  />
</Frame>

### Enhanced Thread Citations and Sources (Beta release)
...
### Account Links in Threads (Beta release)
