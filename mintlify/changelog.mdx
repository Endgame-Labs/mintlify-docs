...
The Endgame MCP Server is out of beta and generally available to all users. Endgame is also now published in the Claude connectors directory, which means admins no longer need to add it by URL as a custom connector — search for **Endgame** under Connectors in Claude, enable it for your organization, and each team member can connect from the same place.

<Frame caption="Finding the Endgame connector in Claude's connector directory">
  <img
    src="/images/endgame-mcp-claude-connector-light-08-13-26.jpg"
    alt="Endgame connector in Claude's connector directory"
    className="rounded-lg mx-auto dark:hidden"
  />
  <img
    src="/images/endgame-mcp-claude-connector-dark-08-13-26.png"
    alt="Endgame connector in Claude's connector directory"
    className="rounded-lg mx-auto hidden dark:block"
  />
</Frame>

Connecting through ChatGPT, Claude Code, Codex, and Claude Managed Agents is unchanged. Learn more about connecting the [Endgame MCP Server](/features/mcp-server).

## June 12, 2026

### SharePoint browsing and Knowledge Files improvements

Working with SharePoint content in Endgame is now easier to manage. When connecting SharePoint, you can browse your sites through their full folder hierarchy and see the files in each library, so you can find and select exactly the content you want to sync. We've also fixed two issues: files removed from SharePoint are now properly removed from Endgame when the source deletes them, and you can now unlink synced Knowledge Files that came in from SharePoint.

Learn more about connecting [Microsoft SharePoint](/integrations/microsoft-sharepoint).

## June 2, 2026

### MCP session data in Team Members table

Admins can now see MCP session activity alongside message data in the Team Members table on the [Usage](https://app.endgame.io/settings/usage) page. The table includes a new **Total MCP Sessions** column, and **Last Activity** now reflects whichever came most recently — a message or an MCP session. This gives admins a fuller picture of how their team is using Endgame across all platforms, including AI assistants connected via the MCP Server.

<Frame caption="Team Members table with MCP session data">
  <img
    src="./images/user-table-with-mcp-06-02-26.png"
    alt="Team Members table showing MCP session data alongside message data"
    className="rounded-lg"
  />
</Frame>

Learn more about the [Endgame MCP Server](/features/mcp-server) and how to get your team connected.

## June 1, 2026

### Seismic integration

Endgame now integrates with Seismic. Connect your Seismic instance to sync both sales enablement materials and engagement and reporting data directly into Endgame, making your content library, usage analytics, and performance insights available as knowledge in chat responses. This includes enablement content like playbooks and pitch decks as well as engagement data that shows how content is being used and performing. Once connected, Endgame ingests your Seismic data automatically.

Learn more about connecting [Seismic](/integrations/seismic).

## May 28, 2026

### Connect your calendar during onboarding

When you first set up Endgame, you can now connect your Google Calendar or Outlook Calendar directly from the onboarding flow. Linking your calendar gives Endgame access to your meeting history, so meeting context (attendees, timing, frequency, and recurrence) is accurate from day one. The more complete your calendar data, the more precise Endgame's responses about account activity, recent conversations, and upcoming meetings.

<Frame caption="Connect your calendar during onboarding">
  <img
    src="./images/calendar_connect_onboarding_05_29_26.png"
    alt="Connect your calendar during onboarding"
    className="rounded-lg"
  />
</Frame>

You can skip this step and connect later at any time under [Settings > Connections](https://app.endgame.io/settings). Learn more about connecting [Google Calendar](/integrations/google-drive#google-calendar-integration) and [Microsoft Outlook Calendar](/integrations/microsoft-outlook-calendar).

## May 26, 2026

### Clari Copilot integration

Endgame now integrates with Clari Copilot. Connect your Clari Copilot instance to sync call recordings and transcripts directly into Endgame, so your conversation data is available alongside CRM records, emails, and Slack when you ask questions about an account. Once connected, Endgame ingests your call data automatically.

Learn more about connecting [Clari Copilot](/integrations/clari-copilot).

## May 19, 2026

### Highspot integration

Endgame now integrates with Highspot. Connect your Highspot instance to sync sales enablement content from your Spots directly into Endgame, making your playbooks, pitch decks, and other resources available as knowledge in chat responses. Once connected, Endgame ingests your selected Spots automatically every 15 minutes.

Learn more about connecting [Highspot](/integrations/highspot).

## May 15, 2026

### MCP Server open beta

The updated Endgame MCP Server is now available to all users in open beta. Connect Endgame to AI assistants like Claude or ChatGPT and give them direct access to your organization's revenue intelligence: CRM records, meeting transcripts, emails, Slack conversations, and more. Your assistant can search interaction history, look up accounts, find stakeholders, and surface insights without leaving the conversation.

<Frame caption="Endgame MCP tools in Claude">
  <img
    src="./images/mcp-in-claude-05-14-26.png"
    alt="Endgame MCP tools in Claude"
    className="rounded-lg"
  />
</Frame>

As this is an open beta, the available tools are actively being developed and are subject to change. Learn more about connecting the [Endgame MCP Server](/features/mcp-server).

## May 6, 2026

### Faster account views and search

We've sped up your Endgame browsing experience. The accounts list view and individual account detail views now load noticeably faster, and searching for accounts returns results more quickly so you can find what you need faster than ever.

## April 16, 2026

### Organization-wide Slack channel data now available in chat

Endgame can now read and process data from organization-wide Slack channels and associate the resulting facts with individual accounts. Previously, messages from organization-wide channels were not surfaced in chat responses. With this update, channels like #marketing or #announcements are processed automatically, and their content is mapped to the relevant accounts so you can reference it in both account-specific and multi-account conversations.

Learn more about configuring [organization-wide channels](/integrations/slack).

## April 8, 2026

### Add files directly to any chat

You can now attach files directly to a chat by clicking the **+** button in the chat input. Attached files appear along the bottom of the input area and apply only to that chat's context, giving you a quick way to bring in additional documents without uploading them to the account's Files tab. Use this feature when you need to narrow down knowledge for a particular chat, you can include images, account-specific content, multi-account documents, and more.

<Frame caption="Files attached to chat input">
  <img
    src="./images/add-files-chat-04-06-26.png"
    alt="Files attached to chat input"
    className="rounded-lg"
  />
</Frame>

Learn more about [using files in chat](/navigating-endgame#adding-files-to-a-chat).

## April 6, 2026

### Microsoft Teams integration

Endgame now integrates with Microsoft Teams. Connect your Teams workspace to sync channel messages into Endgame and associate them with specific accounts. Once connected, your Teams data is ingested automatically every 15 minutes and available to enhance chat responses.

Learn more about connecting [Microsoft Teams](/integrations/microsoft-teams).

### Microsoft SharePoint integration

Endgame now integrates with Microsoft SharePoint. Connect your SharePoint document libraries to sync internal documents, playbooks, and other resources directly into Endgame. Once connected, your document libraries sync immediately and refresh every 15 minutes, making your SharePoint content available in chat responses.
...
Endgame now supports direct integration with Microsoft Outlook Calendar. Adding this calendar source provides more accurate and comprehensive meeting data for use in your chat responses.

If your organization allows Microsoft connections, you can manage your integration under [Settings > Connections](https://app.endgame.io/settings). Click Connect and authenticate with your Microsoft credentials to get started.

Learn more about connecting [Microsoft Outlook Calendar](/integrations/microsoft-outlook-calendar).

<Frame caption="Microsoft Outlook Calendar integration">
  <img
    src="./images/settings-connections-07-28-26.png"
    alt="Microsoft Outlook Calendar integration"
    className="rounded-lg"
  />
</Frame>
...
### Endgame now integrates with Notion

Notion has joined the Endgame integration offerings. Connect your Notion workspace to sync team knowledge like internal wikis, process docs, playbooks, and more directly into Endgame. Once connected, your Notion content is ingested automatically and available to enhance chat responses with your company's collective knowledge.

Learn more about connecting [Notion](/integrations/notion).
...
### Gong call ingest is now up to 4x faster

We've dramatically reduced how long it takes for your Gong call data to be available in Endgame. Previously, call ingest and processing could take up to 2 hours. Now, your call data is usually available within 30 minutes of a call finishing, so you can get insights from your conversations much sooner.

## March 24, 2026

### Deck creation with custom branding

Skills can now generate polished slide decks exported as `.pptx` (PowerPoint) files directly from Endgame. This makes it easy to build customer-facing presentations, QBRs, deal reviews, and other slide-based deliverables without leaving the platform. Simply tell Endgame to create a "deck" in your prompt or configure a skill to produce slide output.

To ensure every deck looks professional and on-brand, admins can configure organization-wide branding in the new Branding configuration settings. Set your color palette, upload light and dark mode logos, and provide design guidelines that the AI will follow when assembling slides. If no branding is configured, decks will use Endgame's default styling.

Learn more about [deck creation](/features/skills#deck-creation) and how to [configure your Branding](/skills/quickstart#configure-your-branding).

<Frame caption="Branding configuration settings">
  <img
    src="./images/brand-kit-form-03-18-26.png"
    alt="Branding configuration settings"
    className="rounded-lg"
  />
</Frame>
...
### WorkOS now Endgame Auth provider

We've migrated to WorkOS as our authentication provider, giving admins more control over how users access Endgame including new provisioning options:

- User invites — Invite users directly with a link they'll use to log in and join your organization.
- Domain verification — Automatically provision any user with a matching email domain via just-in-time provisioning.
- Single Sign-On (select organization access only) — Let users authenticate through your SSO provider of choice, with automatic provisioning on first login.

Existing users are unaffected, all accounts are automatically migrated with no action required. Users will continue signing in with their Salesforce or Google credentials as usual.

Read up on the [new provisioning options](/authentication) and additional details for [managing users](/user-management).
...
You can now upload complex, file-based skills directly into Endgame. From the skills modal, select Add Skill -> Upload a Skill and provide a `.zip` file containing a `SKILL.md` file along with any supporting materials such as example templates, scripts, reference documents, or assets like company logos. This makes it easy to package rich, multi-file skill definitions that go beyond what the basic skill form supports.

Learn more about [creating and uploading skills](/features/skills#creating-skills).

<Frame caption="Upload skill menu">
  <img
    src="./images/upload-skill-menu-03-12-26.png"
    alt="Upload skill menu"
    className="rounded-lg"
  />
</Frame>
...
### Endgame now integrates with Snowflake

We've added Snowflake to our growing list of integrations. Simply connect your Snowflake tables to Endgame through the [integrations page](https://app.endgame.io/settings/integrations) and Endgame will ingest your data. Once ingested, your Snowflake data will be available to chat responses. This includes data your sales team relies on every day — from opportunity and pipeline data to aggregate product usage, renewals, and customer health scores.

Learn [more](/integrations/snowflake) about connecting Snowflake.
...
We've introduced Skills, a significant evolution of our existing Templates functionality. Skills enable more detailed and customizable instructions, allowing for responses that are more accurate, contextually relevant, and aligned with your specific workflows.

Many existing templates have been migrated to Skills and a growing library of Core Endgame Skills is available to all users.

Read more on how to [use](/features/skills) and [create](skills/skills-101) skills.

<Frame caption="Skills modal">
  <img
    src="./images/skills-modal-03-02-26.png"
    alt="Skills modal"
    className="rounded-lg"
  />
</Frame>
...
### Salesforce data processing is now up to 8x faster

We've significantly sped up how we ingest and process your Salesforce data. In most cases, it's now available in Endgame in under an hour. This means the account data surfaced in chat is fresher and more accurate, so you can rely on it for more up-to-date responses.

## February 9, 2026

### Google calendar integration

Endgame now supports direct integration with Google Calendar. Adding this calendar source provides more accurate and comprehensive meeting data for use in your chat responses.

If your organization allows Google connections, you can manage your integration under [Settings > Connections](https://app.endgame.io/settings). Click Connect and authenticate with your Google credentials to get started.

<Frame caption="Google calendar integration">
  <img
    src="./images/google-calendar-integration-02-09-26.png"
...
Introducing a new dashboard for administrators to monitor how your team is using Endgame. Admins can now view team-wide usage data alongside thread content analytics that show what types of content your team is generating. The dashboard also includes user-specific views with individual usage metrics and most recent active times, giving you visibility into engagement patterns across your organization. Access the dashboard in your Admin [settings](https://app.endgame.io/settings/usage) under Usage.

<Frame caption="Admin user dashboard">
  <img
    src="./images/admin-dash-usage-02-04-26.png"
    alt="Admin user dashboard"
    className="rounded-lg"
  />
</Frame>
