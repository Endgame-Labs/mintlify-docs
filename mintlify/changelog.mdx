...
Endgame has enhanced how we handle your CSV and Excel knowledge document uploads. You can now query data from these documents more effectively, performing aggregate, comparison, and filtering operations on tabular data with greater accuracy and reliability.

For older csv and excel documents you may have uploaded in this format, we recommend removing them and reuploading or syncing to take advantage of this improved experience. 
