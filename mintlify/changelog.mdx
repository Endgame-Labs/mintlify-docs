...
Endgame is now officially verified by Google. This verification enables the ability to sync entire folders of content from Google Drive to Endgame and export your thread results directly to Google Sheets and Docs with just a click.

Review our [export](https://docs.endgame.io/features/export-thread-content) and [knowledge](https://docs.endgame.io/features/file-upload) features for more information. 
