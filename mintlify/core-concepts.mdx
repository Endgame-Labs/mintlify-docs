...
You can now seamlessly integrate Endgame with your Slack workspace. Access Endgame directly within your connected Slack channels to ask multi-account and individual account questions, enabling your team to get answers efficiently in one of their primary collaboration environments.
...
<Note>If your team connected Slack prior to October 10, 2025 you need to [update your connection](https://docs.endgame.io/integrations/slack#:~:text=Updating%20an-,existing,-connection%20to%20the) to access the thread feature</Note>
