...
### [Artifacts](/features/publishing-artifacts)

As noted above, templates power structured responses from Endgame's chat, such as specifically formatted account plans, meeting prep briefs, deal reviews, and more. You can publish specific threads generated through chat for the purpose of sharing them, both internally and externally. We call a published thread an Artifact.
