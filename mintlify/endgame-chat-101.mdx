...
Endgame lets you ask any question about the accounts or people in your book of business. There are two ways to ask questions:

1. Ask cross-account questions from the app homepage
2. Ask account-specific questions from any account detail page
...
The following prompts will help you get started. The more questions you ask in a thread, the more insights and ideas you'll tend to get.

Jump to [tips and tricks](#tips-and-tricks) below, or read our [201 article](/endgame-chat-201) on how to approach Endgame more strategically.
...
<CardGroup cols={2}>
  <Card title="Ask follow-up questions" icon="message-circle-question-mark">
  ...
  <Card title="Use multiple perspectives" icon="blend">
  ...
  <Card title="Ask for feedback/grading" icon="goal">
  ...
  <Card title="Ask for quotes" icon="quote">
  ...
  <Card title="Ask for options" icon="list-ordered">
