...
description: 'Connect Endgame to AI coding assistants like Claude Desktop using the Model Context Protocol'
---

## What is the Endgame MCP Server?

The Endgame MCP (Model Context Protocol) Server allows AI coding assistants like Claude Desktop to directly communicate with Endgame. Once connected, you can prompt Endgame to get insights, search conversations, and access customer information without leaving your AI assistant.
...
2. Click your name (bottom left) → **Settings** → **Developer** → **Edit Config**
  ...
  "mcpServers": {
    "endgame": {
      ...
      "args": [
        "-y",
        "mcp-remote",
        "https://your-org.endgame.io/api/bridges/{orgId}/mcp",
        "--header",
...
4. Replace `your-org` and `{orgId}` with your actual organization details
