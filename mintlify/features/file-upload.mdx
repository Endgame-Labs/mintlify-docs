...
Go through the Google authentication process. Select all permissions requested for the best Endgame experience. Once athenticated, select up to 10 files at a time to sync with Endgame. You can edit the description for the files before clicking to Select Files. You can edit the descriptions for the files before clicking to Link Selected Files. 
