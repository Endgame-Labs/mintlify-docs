...
- **What permissions does Endgame request?** Endgame requests [drive.file](https://developers.google.com/workspace/drive/api/guides/api-specific-auth) and [https://developers.google.com/workspace/drive/api/guides/api-specific-auth) permissions.
