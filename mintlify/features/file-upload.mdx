...
To add files access the [**Knowledge?**](https://app.endgame.io/manage/knowledge) view under **Manage** in the user menu.

<Frame caption="File Upload">
  <img
    src="../images/knowledge-upload-options-07-29-26.png"
    alt="files upload"
