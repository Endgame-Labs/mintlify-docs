...
Go through the Google authentication process. Select all permissions requested (we only requst [drive.file](https://www.googleapis.com/auth/drive.file) and [drive.readonly](https://www.googleapis.com/auth/drive.readonly) permissions in the authorization flow) for the best Endgame experience. Once athenticated, select up to 10 files at a time to sync with Endgame. You can edit the description for the files before clicking to Select Files.
