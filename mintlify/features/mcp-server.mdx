...
<Note>
  Want to call Endgame tools directly from your terminal or scripts, without an
  AI assistant? See the [Endgame CLI](/features/cli).
</Note>
...
<Steps>
  <Step title="Admin: Enable the Endgame connector for your organization">
    ...
    1. In Claude, go to **Settings** &rarr; **Connectors**
    ...
    <Frame caption="Finding the Endgame connector in Claude's connector directory">
      <img
        src="../images/endgame-mcp-claude-connector-08-13-26.png"
  ...
  <Step title="Individual: Connect to Endgame">
    ...
    1. Go to **Settings** &rarr; **Connectors** in Claude
...
| `submit_graph_observation` | Record an employment observation about someone at an account -- for example, "Jane joined Acme in March" or "Sam left the company". |
| `submit_endgame_feedback`  | Submit a bug report, feature request, or data issue to the Endgame team.                                                       |
