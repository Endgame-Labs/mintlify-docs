...
Once connected, simply ask Claude questions about your business. You don't need to use any special syntax -- Claude will automatically select the right Endgame tools based on your question.

- "What's new on my accounts this week?"
- "Prepare me for my meeting with Acme Corp tomorrow"
- "What competitors are being mentioned in recent calls?"
- "Find me the VP of Engineering at Snowflake"
- "What did our team discuss about the renewal in Slack?"

For complex analyses, Claude can chain multiple tools together -- for example, finding an account, pulling recent interactions, and querying your data warehouse to build a complete picture.
