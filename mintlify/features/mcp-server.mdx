...
We recommend connecting Endgame through the **Endgame connector in Claude's connector directory**, the **ChatGPT Codex app**, or directly in a **Claude Code** or **Codex** terminal session. All options give your AI assistant direct access to all Endgame tools.
...
<Note>
  Endgame periodically updates our MCP tools. An admin can ensure you have the latest tool set by clicking into the Endgame app -\> See details for the tools -\> Refresh
</Note>
