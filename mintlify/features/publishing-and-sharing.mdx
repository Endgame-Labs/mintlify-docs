...
Once you have generated a thread with a skill that outputs an artifact, you will see that artifact within the thread response. Some artifact types will show a preview image of the artifact, you can click this image to open a larger preview in a new tab. From this tab you can choose to download, publish, or export your artifact to Google Drive. You can also click to publish the artifact or export to Google Drive directly from the initial preview image.

<Frame caption="Artifact within thread">
  <img
    src="../images/artifact-within-thread-03-13-26.png"
    alt="Artifact within thread"
    className="rounded-lg"
  />
</Frame>

<Frame caption="Artifact preview">
  <img
    src="../images/artifact-preview-03-13-26.png"
    alt="Artifact preview"
    className="rounded-lg"
  />
</Frame>

Other artifacts types will show options for downloading or publishing without a preview. Publishing creates a shareable url that gives _anyone_, including non-Endgame users, with the url access to the artifact. You can unpublish at anytime.

<Frame caption="Artifact within thread">
  <img
    src="../images/artifact-within-thread-no-preview-03-02-26.png"
    alt="Artifact within thread"
    className="rounded-lg"
  />
</Frame>
...
<Frame caption="Artifact account view">
  <img
    src="../images/artifact-account-view-02-25-26.png"
