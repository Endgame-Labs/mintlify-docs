...
<Tip>
  Organization **Branding** settings are located in the admin [settings](https://app.endgame.io/settings/branding). This ensures slides use your company's colors, logos, and design guidelines. See the [Branding setup guide](/skills/quickstart#configure-your-brand-kit) for details.
</Tip>
