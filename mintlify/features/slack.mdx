...
<Info>
External channels intentionally prevent bot chat functionality to avoid exposing internal organization data to outside users via chat.<br/>Organization-wide channels are intended for multi-account inquiries, while account-specific channels are intended for questions related to individual accounts.
</Info>
