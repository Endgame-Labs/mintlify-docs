...
You can also use templates for more broadly scoped threads that touch multiple accounts. To ask a question that is not account specific, navigate to the Endgame [homepage](https://end-p1.endgame.io/). These templates and the template modal work the same way as the account specific templates, but you won't see your account templates here or vice versa. And, you can save your own in My Templates at this level as well.
