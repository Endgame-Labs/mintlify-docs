...
## How to use templates for an multi-account (book) thread

You can also use templates for more broadly scoped threads that touch multiple accounts. We often refer to these types of threads as "book level" threads. To ask a question that is not account specific, navigate to the Endgame [homepage](https://end-p1.endgame.io/). These templates and the template modal work the same way as the account templates, but you won't see your account templates here or vice versa. 
