...
<Frame caption="Access templates via the 'Use Prompt Template' button in the chat interface">
  <img
...
<Frame caption="Browse and select from available prompt templates">
  <img
