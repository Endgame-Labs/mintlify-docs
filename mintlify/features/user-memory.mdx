---
title: 'User Memory'
description: 'Personal peferences to improve your chat experience'
icon: 'bookmark-plus'
---

<Info>User memory is in Beta and only available to select users</Info>
...
For users with Memory enabled, the feature is toggled on by default to capture your memories. You can update this setting in the [user settings view](https://app.endgame.io/settings). When Memory is toggled on, your memories from chat are stored and used in your chat responses. When toggled off, new memories are not saved and existing memories, if any, are not used in chat responses.
