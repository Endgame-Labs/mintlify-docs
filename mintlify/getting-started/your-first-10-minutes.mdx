...
<Steps>
  ...
  <Step title="Describe your role">
    In the **Personalization** section, fill out the "Describe your role" field. Be specific about what you do day-to-day.
...
## Step 2: Pick an account you know (1 minute)

For your first question, pick an account you're already familiar with. This way, you can tell if Endgame's insights are accurate and useful.

Use the search bar (or press `⌘K`) to find the account, then click into the account detail page.
...
## Step 4: Read the response (2 minutes)
...
<CardGroup cols={2}>
  ...
  <Card title="Ask across all accounts" icon="layers" href="/navigating-endgame">
