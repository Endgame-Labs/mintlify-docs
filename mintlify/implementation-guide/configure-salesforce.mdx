...
<Info>
  **Learning path:** [Implementation Guide](/implementation-guide/overview) · Module 1 of 8 · ~10 minutes
</Info>
...
<Columns cols={2}>
  ...
  <Column>
    <Card icon="arrow-big-right" horizontal href="implementation-guide/connect-conversations" title="Next Module">
