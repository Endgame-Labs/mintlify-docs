...
<Info>
  **Learning path:** [Implementation Guide](/implementation-guide/overview) · Module 3 of 8 · ~10 minutes
</Info>
...
<Note>
  If your team doesn't use Slack, or uses a different messaging platform, skip this module and move to [Upload Knowledge](/implementation-guide/upload-knowledge).
</Note>
