...
<Info>
  Already have an Endgame instance that's been configured? The [Admin Quick Start](/implementation-guide/admin-quick-start) path is designed for new admins joining an existing deployment.
</Info>
...
<CardGroup cols={2}>
  <Card icon="plug" href="/implementation-guide/initial-setup-guide" title="1. Initial Setup Guide">
    Authenticate via Salesforce, approve the connected app, and kick off data ingestion
  </Card>
  <Card icon="database" href="/implementation-guide/configure-salesforce" title="2. Configure Salesforce Fields">
    Tell Endgame which custom fields matter so responses reference the right data
  </Card>
  <Card icon="book-open" href="/implementation-guide/connect-conversations" title="3. Connect Conversations">
    Verify your call recording integration and understand what flows in
  </Card>
  <Card icon="hash" href="/implementation-guide/connect-slack" title="4. Connect Slack">
    Map Slack channels to accounts so internal context powers Endgame responses
  </Card>
  <Card icon="upload" href="/implementation-guide/upload-knowledge" title="5. Upload Knowledge">
    Add your sales methodology, battlecards, and playbooks
  </Card>
  <Card icon="pen-line" href="/implementation-guide/create-first-rule" title="6. Create Your First Rule">
    Teach Endgame your org's terminology and CRM conventions
  </Card>
  <Card icon="hammer" href="/implementation-guide/build-first-skill" title="7. Build Your First Skill">
    Turn a repeatable workflow into a reusable skill your team can run
  </Card>
  <Card icon="car" href="/implementation-guide/test-drive" title="8. Test Drive">
    Validate your configuration by chatting with Endgame across a few accounts
  </Card>
  <Card icon="users" href="/implementation-guide/invite-team" title="9. Invite Your Team">
...
<Columns cols={2}>
  ...
  <Column>
    <Card icon="arrow-big-right" horizontal href="implementation-guide/initial-setup-guide" title="Next Module">
      Initial Setup Guide
    </Card>
  </Column>
</Columns>