...
<CardGroup cols={2}>
  <Card icon="plug" href="/implementation-guide/login-and-connect-crm" title="1. Login & Connect CRM">
...
<Columns cols={2}>
  ...
  <Column>
    <Card icon="arrow-big-right" horizontal href="implementation-guide/login-and-connect-crm" title="Next Module">
      Login & Connect CRM
    </Card>
  </Column>
</Columns>