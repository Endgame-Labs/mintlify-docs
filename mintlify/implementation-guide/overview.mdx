...
<CardGroup cols={2}>
  ...
  <Card icon="book-open" href="/implementation-guide/connect-conversations" title="2. Connect Transcripts">
    Verify your call recording integration and understand what flows in
  </Card>
  <Card icon="hash" href="/implementation-guide/connect-slack" title="3. Connect Chat">
    Map Slack channels to accounts so internal context powers Endgame responses
  </Card>
  <Card icon="upload" href="/implementation-guide/upload-knowledge" title="4. Upload Knowledge">
    Add your sales methodology, battlecards, and playbooks
  </Card>
  <Card icon="pen-line" href="/implementation-guide/create-first-rule" title="5. Create Your First Rule">
    Teach Endgame your org's terminology and CRM conventions
  </Card>
  <Card icon="hammer" href="/implementation-guide/build-first-skill" title="6. Build Your First Skill">
    Turn a repeatable workflow into a reusable skill your team can run
  </Card>
  <Card icon="database" href="/implementation-guide/configure-salesforce" title="7. Configure Salesforce Fields">
