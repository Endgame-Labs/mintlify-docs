...
<Warning>
  To connect to the Clari Copilot API, you must be a Clari Copilot Administrator, and your organization must have an Enterprise plan.
</Warning>
...
<Steps>
  ...
  <Step title="Update your connection">
    ...
    <Frame caption="Clari Copilot manage view">
      <img
        src="../images/clari-manage-view-03-26-26.png"
