...
Use the instructions below to enable the Confluence integration in Endgame. Once enabled, Endgame will process the content from designated spaces and provide insights via the Endgame UI.
...
<Steps>
  <Step title="Access integrations">
    ...
    <Frame caption="Confluence connection">
      <img
        src="../images/confluence-connection-05-06-26.png"
        alt="Confluence connection"
