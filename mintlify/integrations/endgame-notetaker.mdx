...
The Notetaker will be very visible when joining your meeting, it will generate a transcript of the meeting content. Once complete, Endgame will process that transcript data and associated it to an account making it available to Endgame chat responses.
...
| **How does the Notetaker know which account to associate my meeting with?**         | ??                                                                                                                                                                           |
| **How long does it take for my transcript to be available to Endgame chat?**        | ??                                                                                                                                                                           |
...
| **What happens if multiple Notetakers join a single meeting?**                      | Rarely more than one Notetaker may join your meeting due to meeting record duplication, simply remove one (or all) of the Notetakers from your meeting.                      |
