...
<Steps>
  ...
  <Step title="Start Setup">
    From the configuration page, click "Setup" to kick off the Gong authentication process
    
    <img src="/images/gong-setup-button.png" alt="Gong setup button" className="rounded-lg" />
  </Step>
  
  <Step title="Grant Access">
    In the resulting page, click "Allow" to grant Endgame access to your Gong Account
    
    <img src="/images/gong-authorization.png" alt="Gong authorization page" className="rounded-lg" />
  </Step>
</Steps>
