...
<Warning>
  Access to Google integrations is managed by your organization. If these
  integrations aren't visible in Endgame, your organization hasn't enabled them
  yet.
</Warning>
...
<Frame caption="Google Drive connection">
  <img
    src="../images/settings-connections-04-01-26.png"
    alt="Google Drive connection"
