...
<Warning>
  Make sure you've informed these users beforehand, because as part of the authentication process, they will receive an email from us for verification. This is for security and safety purposes, to make sure they are in control of the account.
</Warning>