...
<Steps>
  ...
  <Step title="Select Spots to connect">
    After authenticating, you will see a list of available Spots from your Highspot instance. Select the Spots you want Endgame to ingest content from, then confirm your selection.
  ...
  <Step title="View and edit connected Spots">
    Once connected, you can view and manage your selected Spots at any time from the Highspot integration page. You can add or remove Spots as your needs change.
  ...
  <Step title="Updating your connection">
    Users can disconnect their Highspot connection at any time. Disconnecting will stop the ingestion of new content from Highspot. To disconnect, click the Disconnect button in the lower left-hand corner.
...
That's it! Now that you've connected Highspot to Endgame, we'll automatically ingest your Spot content and present our insights in Endgame.
