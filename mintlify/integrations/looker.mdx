...
Users can delete a saved query at anytime by hovering over the query and clicking on the trash icon. 
  ...
  <Info>
Because of their nature, Looker queries are assumed to be applicable at an organization level applying to many accounts. They are not account specific.</Info>
</Steps>