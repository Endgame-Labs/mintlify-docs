...
<Steps>
  ...
  <Step title="Select Account">
    Select the account you wish to connect to Endgame and go through the authentication flow and ensure you check the box to give Endgame permission for the specified scopes.
