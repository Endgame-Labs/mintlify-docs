...
<Steps>
  ...
  Users can update or disconnect their Teams connection at anytime. Disconnecting will remove all your existing channel to account mappings. To update your connection hover over the Connect button in the top right corner and when it shows Reconnect, click it to trigger the authentication process. To disconnect, click the Disconnect button in the lower left hand corner.
