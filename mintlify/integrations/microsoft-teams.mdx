...
<Note>
  Connecting to the Microsoft Teams API requires that the connecting user is a
  Teams Global Administrator.
</Note>
...
<Steps>
  ...
  <Step title="Start Setup">
    From the integrations page, click "Connect" to kick off the Teams authentication process.
        ...
        <Frame caption="Microsoft Teams connection">
        <img
            src="../images/microsoft-teams-integration-03-09-26.png"
            alt="Microsoft Teams connection"
  ...
  <Step title="Select Account">
    Select the account you wish to connect to Endgame and go through the authentication flow and ensure you check the box for "Consent on behalf of your organization" to give Endgame access to the necessary scopes.
  ...
  <Step title="Configure Channel Mapping">
    Once connected, click to Manage your configuration. You can now designate which public Teams channel content will be associated with specific Endgame Accounts.
    ...
    Second, choose which account to association with that channel and click Add. Channel data is synced to Endgame every 15 minutes.
  ...
  Users can update or disconnect their Teams connection at anytime. Disconnecting will remove all your existing channel to account mappings. 
  
  To update your connection with a new user hover over the Connect button in the top right corner and when it shows Reconnect, click it to trigger the authentication process. To disconnect, click the Disconnect button in the lower left hand corner.
