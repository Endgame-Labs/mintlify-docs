...
Endgame syncs your page data every hour, you can trigger an immediate sync by clicking on the Sync button.
...
Page content can be deleted by clicking the trash icon for the page. Note that deleting a page with nested content will delete all nested page content as well, if you wish to only exclude certain nested pages, follow the instructions above.
  ...
  Users can update or disconnect their Notion connection at anytime. Disconnecting will remove all your existing page data and the links you have created. 
