...
Endgame allows administrators to tell Endgame specific fields to focus on, as Salesforce instances often have hundreds of fields and only a handful truly matter to help your colleagues deeply understand their accounts.
...
<Steps>
  ...
  <Step title="Mark select fields as important">
    Search for and mark "Important" the fields you want Endgame to focus on. Then, click "Submit Changes". It will take a few minutes for your changes to percolate.

    <Warning>
      You can only select up to 50 fields per object.
    </Warning>
