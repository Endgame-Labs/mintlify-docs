...
<Note>
  Only accounts the integration user has permission to in Salesforce will be run
  through any AI systems. The integration user is the one you first log in with
  after consultation with Endgame. The user can be updated by going to the
  [integration page](https://app.endgame.io/settings/integrations/salesforce),
  hovering over the Connect button in the top right corner and clicking
  Reconnect.
</Note>
...
<Steps>
  ...
  Select an object from the Required Objects list.
...
<Frame caption="Required object configuration">
  ...
  <img
    src="../images/configure-object-field-modal-1-6-26.png"
...
Endgame utilizes a set of Salesforce objects by default in your chat responses. You can add addtional objects to be referenced for chat responses in the [Salesforce admin configuration](https://app.endgame.io/settings/integrations/salesforce) under the Additional Objects section. Simply toggle the additional objects on for them to be processed.

<Frame caption="Additonal Salesforce objects">
  <img
    src="../images/additional-salesforce-objects-1-6-26.png"
