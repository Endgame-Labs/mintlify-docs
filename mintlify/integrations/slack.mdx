...
Additionally, you have the option to configure Organization-Wide Channels. While these channels do not contribute data for analytical purposes, they facilitate multi-account Endgame conversations within those specific channels.
    ...
    To connect a non-account specific channel, "Select channels to ingest" and Submit. 
...
That's it\! Now that you've connected Slack to Endgame, we'll automatically ingest your data into our systems every 15 minutes and present our insights in Endgame. For comprehensive guidance on utilizing Endgame within Slack, check out our [Slack](/features/slack) documentation.
