...
<Steps>
  ...
  <Step title="Start Setup">
    ...
    <Frame>
      <img
        src="/images/slack-setup-button.png"
        alt="Slack setup button"
  ...
  <Step title="Configure Channel Mapping">
    ...
    <Frame>
      <img
        src="/images/slack-channel-mapping.png"
...
We will _only_ ingest channels that you have selected and associated with an Account. Other than the names of public channels, no other data gets ingested without your permission.
