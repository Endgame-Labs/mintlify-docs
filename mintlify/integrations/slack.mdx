...
<Steps>
  ...
  <Step title="Start Setup">
    ...
    <img src="/images/slack-setup-button.png" alt="Slack setup button" className="rounded-lg" />
  </Step>
  ...
  <Step title="Grant Permissions">
    ...
    <img src="/images/slack-permissions.png" alt="Slack permissions page" className="rounded-lg" />
  </Step>
  ...
  <Step title="Configure Channel Mapping">
    ...
    <img src="/images/slack-channel-mapping.png" alt="Channel mapping configuration" className="rounded-lg" />
