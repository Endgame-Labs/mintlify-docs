...
<Steps>
  ...
  <Step title="Add snowflake objects">
    ...
    <Danger>
      Snowflake views should contain summary or aggregated data. Endgame can not process and analyze raw event data.

      **We recommend that any table contain 20k rows or less for best performance.**
    </Danger>
