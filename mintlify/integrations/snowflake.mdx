...
```
GRANT ROLE endgame_connector_readonly TO USER endgame_service;

ALTER USER endgame_service SET DEFAULT_WAREHOUSE = <your_warehouse>;
ALTER USER endgame_service SET DEFAULT_ROLE = endgame_connector_readonly;
```
