...
<Steps>
  ...
  <Step title="Start Setup">
    ...
    <img src="/images/zoom-setup-authorization.png" alt="Zoom setup button" className="rounded-lg" />
  </Step>
  
  <Step title="Grant Access">
    In the resulting page, click "Allow" to grant Endgame access to your Zoom Account
    
    <img src="/images/zoom-setup-authorization.png" alt="Zoom authorization page" className="rounded-lg" />
  </Step>
</Steps>
