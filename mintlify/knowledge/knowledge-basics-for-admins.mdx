---
title: "Sales Knowledge: What to Connect"
...
1. **Process and role guides**: MEDDIC, BANT, or your own custom framework; what matters is how _your team_ uses the process, not just the generic description anyone can find on the web. Also toss in roles and responsibilities -- what you teach AEs to do vs SEs, AMs, CSMs, etc.
2. **Competitive battlecards** for your top 3-5 competitors. Basic positioning notes are fine.
