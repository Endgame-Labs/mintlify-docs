...
<Frame caption="Create skill modal">
  <img
    src="/images/create-skill-02-19-26.png"
    alt="Create skill modal"
    className="rounded-lg"
  />
</Frame>
...
<Frame caption="Upload skill menu">
  <img
    src="/images/upload-skill-menu-03-12-26
    .png"
...
Often using a skill within a thread will generate an "artifact". These artifacts can be slide decks, dashboards, excel spreadsheets, and more. Read [more](/legacy-endgame/features/publishing-and-sharing#skill-artifacts) about how you can publish these artifacts to share them with your team or external stakeholders.
