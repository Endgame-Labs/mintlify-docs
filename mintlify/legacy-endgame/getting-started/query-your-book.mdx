...
In [Your First 10 Minutes](/legacy-endgame/getting-started/your-first-10-minutes), you asked questions about a single account. But Endgame can also answer questions across your entire book of business or the entire organization.
...
<Frame caption="Endgame homepage">
  ![Image](/images/home-page-04-06-26.png)
</Frame>
...
**Schedule it:** Use [Tasks](/legacy-endgame/features/tasks) to get book-level insights delivered to your inbox on a schedule.
...
<AccordionGroup>
  ...
  <Accordion title="Can I save queries or workflows?">
    Yes. Save them as skills or schedule them as [Tasks](/legacy-endgame/features/tasks) to run
    automatically.
  </Accordion>
...
<CardGroup cols={2}>
  <Card
    title="Schedule a weekly digest"
    icon="calendar-clock"
    href="/legacy-endgame/features/tasks"
  >
