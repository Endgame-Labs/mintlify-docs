...
<Frame caption="Account detail view">
  ![A snippet of an account page in
  Endgame](/images/account-chat-detail-04-06-26.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Get a daily digest" icon="calendar-clock" href="/legacy-endgame/features/tasks">
    Schedule insights delivered to your inbox
  </Card>
  <Card title="Ask across all accounts" icon="layers" href="/legacy-endgame/getting-started/query-your-book">
    Query your entire book from the homepage
  </Card>
  <Card
    title="Better prompting patterns"
    icon="graduation-cap"
    href="/legacy-endgame/getting-started/endgame-chat-201"
  >
    Level up with advanced techniques
  </Card>
  <Card title="Create a skill" icon="bookmark" href="/legacy-endgame/features/skills">
...
<AccordionGroup>
  ...
  <Accordion title="Can other people see my conversations?">
    No. Your threads are private by default. The only way someone else can see a thread is if you explicitly [Share](/legacy-endgame/features/publishing-and-sharing) it. Even then, you can stop sharing at any time.
  </Accordion>
