...
After you [login](https://app.endgame.io/login) with your Salesforce credentials, you'll be presented with Endgame's [home page](https://app.endgame.io/). On the home page you can [query across multiple accounts](/query-your-book). Here you can explore prompts that cover the entire breadth of the accounts in your organization.
...
You can view multi-account (book), account, and task thread history in the [Thread List view](https://app.endgame.io/threads) accessed in the left-hand navigation. Your targeted account thread history also lives in that account's Library. You can search by thread title or account name and filter based on thread type.

<Frame caption="Thread list view">
  <img
    src="./images/threads-list-view-02-25-26.png"
...
Toggle Research Mode on for deeper thinking.
