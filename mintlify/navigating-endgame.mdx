...
The Threads tab contains an index of all the threads associated with this account, which is your Ask AI chat history of that account. This allows you to quickly go back to any chat you have had regarding the account as well as provide a mechanism for collaboration with other members of your team.
