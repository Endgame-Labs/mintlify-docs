...
You can view multi-account (book) thread history in the [Thread List view](https://app.endgame.io/threads) accessed in the left-hand navigation. Your targeted account thread history lives in that account's Library. You can search by thread title.
