...
```
I have time for 5 prospecting calls this week. 
Which accounts should I prioritize and why?
```
...
```
Give me a weekly brief for my book. 
Include: deals that need action, accounts with recent news, and any meetings coming up.
```

```
What happened across my accounts last week? 
Summarize key emails, calls, and any notable events.
```
...
```
In deals where [Competitor] came up, what objections or concerns did prospects raise? 
How did we respond?
```
...
**Save as a template:** If you find yourself running the same query weekly, [save it as a template](/templates/templates-101) so you can rerun it with one click.

**Schedule it:** Use [Tasks](/features/tasks) to get book-level insights delivered to your inbox on a schedule.

---

## Book-level vs. account-level: a quick guide

| I want to...                                     | Where to ask |
| ------------------------------------------------ | ------------ |
| Research one specific company                    | Account page |
| Find which accounts need attention               | Homepage     |
| Prep for a meeting with Acme Inc                 | Account page |
| Prep for my weekly pipeline review               | Homepage     |
| Write an email to a specific contact             | Account page |
| See what competitors are showing up across deals | Homepage     |
| Analyze why we're losing deals                   | Homepage     |
| Deep-dive on a single deal                       | Account page |
| Prioritize my week                               | Homepage     |
