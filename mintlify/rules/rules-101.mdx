...
System rules are always active, regardless of what's being asked. Additional system rules cannot be created. There are two:
...
**Deleting a rule:** Click delete on any custom rule card and confirm. System rules cannot be deleted, and should always be populated.
