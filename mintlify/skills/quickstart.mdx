...
<Steps>
  <Step title="Access your skills in the manage section">
    Navigate to https://app.endgame.io/manage/skills

   <Frame caption="Admin Skills">
        <img
            src="../images/skills-admin-view-07-31-26.png"
            alt="Admin Skills"
...
<Info>
  ...
  editing, or deleting applies to your entire organization.
     ...
     <Frame caption="Add skill menu">
        <img
            src="../images/upload-skill-menu-07-31-26.png"
            alt="Add skill menu"
            className="rounded-lg"
        />
    </Frame>
  ...
  <Step title="Edit or Delete a skill">
    Open the overflow menu (three dots) in the top right of any skill to edit or delete it
       ...
       <Frame caption="Skill overflow menu">
          <img
              src="../images/skill-overflow-menu-07-31-26.png"
