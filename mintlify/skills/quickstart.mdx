...
<Info>
  ...
  <Step title="Promote a personal skill to your organization">
    ...
    <Info>
      Only admins can promote skills, and only skills they personally own. Once promoted, the skill is managed like any other organization skill — editable and deletable from the admin settings.
    </Info>
...
<Info>
  Branding currently applies to slide deck outputs only. Support for additional
  artifact types is coming soon.
</Info>
