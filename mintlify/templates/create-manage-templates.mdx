...
<Steps>
  <Step title="Access your templates in settings">
    ...
    ![admin template](/images/admin-templates-8-24-25.png)
  </Step>
  <Step title="Add, edit, delete">
    ...
    - Delete a template by clicking Delete template in the lower left hand corner of the template edit form.
      ...
      ![delete template](/images/delete-template-8-26-25.png)
