...
You have the option to add verified domains which will allow any user attempting to login with that domain access to Endgame. For example if you verify acme.co and sarah@acme.co attempts to login to Endgame using that email address, she will be provisioned as a user for your org and allowed to authenticate.
...
You have the option to enable SSO for you organization, you must first verify your organization domains to complete SSO configuration. Enabling SSO allows xx users to authenticate and be provisioned. You will need to click on xx and follow these steps to enable this service.
