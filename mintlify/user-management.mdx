...
- access and ability to edit all organization configuration in [manage](https://app.endgame.io/manage) including: integrations, user management, rules, knowledge, skills, and api key generation.
