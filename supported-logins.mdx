...
- **Salesforce** - Sign in with your existing Salesforce credentials (the default method)
- **Google** - Sign in with your Google account (more details [here](/mintlify/integrations/google-logins))
